...
export const COMPONENT_REGISTRY: ComponentMeta[] = [
  // ==================== 基础组件 ====================
  {
    ...
    displayName: '按钮',
    category: 'basic',
    keywords: ['btn', '按钮', '提交', '确认', '取消', '点击', '操作', 'click', 'submit', 'confirm'],
  ...
  },
  {
    ...
    displayName: '边框',
    category: 'basic',
    keywords: ['border', '边框', '线', '分割线', 'divider'],
    related: ['divider'],
    complexity: 'simple',
  ...
  },
  {
    ...
    displayName: '卡片',
    category: 'basic',
    keywords: ['card', '卡片', '容器', '面板', 'panel', 'box'],
  ...
  },
  {
    ...
    displayName: '色彩',
    category: 'basic',
    keywords: ['color', '色彩', '颜色', '主题', 'theme', '配色'],
  ...
  },
  {
    ...
    displayName: '布局容器',
    category: 'basic',
    keywords: ['container', '布局', '容器', 'layout', 'wrapper'],
    related: ['layout', 'card'],
    complexity: 'simple',
  ...
  },
  {
    ...
    displayName: '分割线',
    category: 'basic',
    keywords: ['divider', '分割线', '分隔线', '横线', 'border', 'separator'],
    related: ['border'],
    complexity: 'simple',
  ...
  },
  {
    ...
    displayName: '图标',
    category: 'basic',
    keywords: ['icon', '图标', 'iconfont', 'svg', 'symbol', 'font-awesome'],
  ...
  },
  {
    ...
    displayName: '布局',
    category: 'basic',
    keywords: ['layout', '布局', '栅格', 'grid', 'row', 'col', 'column', 'flex'],
  ...
  },
  {
    ...
    displayName: '文字链接',
    category: 'basic',
    keywords: ['link', '链接', '文字链接', '超链接', 'a', 'href', 'anchor'],
  ...
  },
  {
    ...
    displayName: '间距',
    category: 'basic',
    keywords: ['space', '间距', '间隔', 'gap', 'margin', 'padding'],
    related: ['layout'],
    complexity: 'simple',
  ...
  },
  {
    ...
    displayName: '排版',
    category: 'basic',
    keywords: ['typography', '排版', '文字', '字体', '标题', 'paragraph', 'text'],
    related: [],
    complexity: 'simple',
  ...
  // ==================== 表单组件 ====================
  {
    ...
    displayName: '多选框',
    category: 'form',
    keywords: ['checkbox', '多选', '多选框', '勾选', 'check', '多选项', '复选框'],
  ...
  },
  {
    ...
    displayName: '颜色选择器',
    category: 'form',
    keywords: ['color-picker', '颜色选择器', '取色器', 'color', '颜色'],
    related: ['form', 'color'],
    complexity: 'medium',
  ...
  },
  {
    ...
    displayName: '日期选择器',
    category: 'form',
    keywords: ['date-picker', '日期选择器', '日期', 'date', 'calendar', '日历', 'datepicker'],
  ...
  },
  {
    ...
    displayName: '日期时间选择器',
    category: 'form',
    keywords: ['datetime-picker', '日期时间选择器', '日期时间', 'datetime', '时间日期'],
  ...
  },
  {
    ...
    displayName: '表单',
    category: 'form',
    keywords: ['form', '表单', '提交', '验证', '校验', 'validate', 'input', 'field'],
  ...
  },
  {
    ...
    displayName: '输入框',
    category: 'form',
    keywords: ['input', '输入框', '文本框', 'text', '输入', '表单', 'textarea'],
  ...
  },
  {
    ...
    displayName: '数字输入框',
    category: 'form',
    keywords: ['input-number', '数字输入框', '数字', 'number', '计数器', 'spinner'],
  ...
  },
  {
    ...
    displayName: '单选框',
    category: 'form',
    keywords: ['radio', '单选', '单选框', 'radio-button', '选项', '选择'],
  ...
  },
  {
    ...
    displayName: '评分',
    category: 'form',
    keywords: ['rate', '评分', '星级', '星星', 'star', 'rating'],
    related: ['form', 'slider'],
    complexity: 'simple',
  ...
  },
  {
    ...
    displayName: '选择器',
    category: 'form',
    keywords: ['select', '选择器', '下拉', '下拉框', 'dropdown', 'option', '选择'],
  ...
  },
  {
    ...
    displayName: '滑块',
    category: 'form',
    keywords: ['slider', '滑块', '滑动', 'range', '范围', '进度'],
  ...
  },
  {
    ...
    displayName: '开关',
    category: 'form',
    keywords: ['switch', '开关', '切换', 'toggle', 'on-off', '布尔'],
  ...
  },
  {
    ...
    displayName: '时间选择器',
    category: 'form',
    keywords: ['time-picker', '时间选择器', '时间', 'time', '时钟'],
  ...
  },
  {
    ...
    displayName: '时间选择',
    category: 'form',
    keywords: ['time-select', '时间选择', '固定时间', 'time'],
  ...
  },
  {
    ...
    displayName: '穿梭框',
    category: 'form',
    keywords: ['transfer', '穿梭框', '转移', '移动', '左右选择', 'shuttle'],
  ...
  },
  {
    ...
    displayName: '上传',
    category: 'form',
    keywords: ['upload', '上传', '文件上传', '图片上传', 'file', 'image', '附件'],
    related: ['form'],
    complexity: 'medium',
  ...
  },
  {
    ...
    displayName: '级联选择器',
    category: 'form',
    keywords: ['cascader', '级联', '级联选择器', '多级选择', '省市区', '树形选择'],
  ...
  // ==================== 数据展示 ====================
  {
    ...
    displayName: '头像',
    category: 'data',
    keywords: ['avatar', '头像', '用户头像', '图片', 'photo', 'user'],
    related: ['image', 'badge'],
    complexity: 'simple',
  ...
  },
  {
    ...
    displayName: '徽标数',
    category: 'data',
    keywords: ['badge', '徽标', '红点', '角标', '标记', '未读', 'count', 'dot'],
  ...
  },
  {
    ...
    displayName: '日历',
    category: 'data',
    keywords: ['calendar', '日历', '日期', 'date', '日程', '月份'],
  ...
  },
  {
    ...
    displayName: '走马灯',
    category: 'data',
    keywords: ['carousel', '走马灯', '轮播', '轮播图', 'swiper', 'slider', 'banner'],
    related: ['image'],
    complexity: 'medium',
  ...
  },
  {
    ...
    displayName: '折叠面板',
    category: 'data',
    keywords: ['collapse', '折叠', '折叠面板', '手风琴', 'accordion', '展开', '收起'],
    related: ['card'],
    complexity: 'simple',
  ...
  },
  {
    ...
    displayName: '描述列表',
    category: 'data',
    keywords: ['descriptions', '描述列表', '详情', 'description', '信息展示'],
    related: ['table', 'form'],
    complexity: 'simple',
  ...
  },
  {
    ...
    displayName: '空状态',
    category: 'data',
    keywords: ['empty', '空状态', '暂无数据', '空白', 'no-data', 'placeholder'],
    related: ['table', 'image'],
    complexity: 'simple',
  ...
  },
  {
    ...
    displayName: '图片',
    category: 'data',
    keywords: ['image', '图片', 'img', '照片', '预览', 'preview', '大图'],
  ...
  },
  {
    ...
    displayName: '无限滚动',
    category: 'data',
    keywords: ['infiniteScroll', '无限滚动', '滚动加载', 'load-more', '下拉加载', '虚拟滚动'],
    related: ['table', 'list'],
    complexity: 'medium',
  ...
  },
  {
    ...
    displayName: '分页',
    category: 'data',
    keywords: ['pagination', '分页', '页码', 'page', '翻页', 'table-page'],
  ...
  },
  {
    ...
    displayName: '进度条',
    category: 'data',
    keywords: ['progress', '进度条', '进度', 'progress-bar', 'loading', '百分比'],
  ...
  },
  {
    ...
    displayName: '结果',
    category: 'data',
    keywords: ['result', '结果', '成功', '失败', '404', '403', '500', '状态页'],
  ...
  },
  {
    ...
    displayName: '骨架屏',
    category: 'data',
    keywords: ['skeleton', '骨架屏', '加载占位', 'loading', 'placeholder', 'shimmer'],
  ...
  },
  {
    ...
    displayName: '表格',
    category: 'data',
    keywords: ['table', '表格', '列表', 'list', 'grid', '数据表格', 'table-view', 'table-page'],
  ...
  },
  {
    ...
    displayName: '配置表格',
    category: 'data',
    keywords: ['table-config', '配置表格', '配置化表格', '动态表格', 'JSON表格'],
    related: ['table', 'table-page'],
    complexity: 'complex',
  ...
  },
  {
    ...
    displayName: '分页表格',
    category: 'data',
    keywords: ['table-page', '分页表格', '分页查询', '带分页的表格', '自动分页'],
  ...
  },
  {
    ...
    category: 'data',
    keywords: ['table-page-virtual', '虚拟滚动', '大数据表格', '性能优化', 'virtual-scroll'],
  ...
  },
  {
    ...
    displayName: '视图表格',
    category: 'data',
    keywords: ['table-view', '视图表格', '只读表格', '展示表格'],
  ...
  },
  {
    ...
    displayName: '标签',
    category: 'data',
    keywords: ['tag', '标签', '标记', 'label', 'badge', '分类'],
    related: ['badge'],
    complexity: 'simple',
    docPath: 'docs/tag.md',
  },
  {
    ...
    displayName: '时间线',
    category: 'data',
    keywords: ['timeline', '时间线', '时间轴', '步骤', '历史', '流程'],
    related: ['steps'],
    complexity: 'simple',
  ...
  },
  {
    ...
    displayName: '树形控件',
    category: 'data',
    keywords: ['tree', '树', '树形控件', '树形选择', '层级', '目录', 'folder'],
  ...
  },
  {
    ...
    displayName: '统计数值',
    category: 'data',
    keywords: ['statistic', '统计', '数值', '数字', 'count', 'number', 'dashboard'],
  ...
  // ==================== 反馈组件 ====================
  {
    ...
    displayName: '警告',
    category: 'feedback',
    keywords: ['alert', '警告', '提示', '通知', 'warning', 'info', 'message'],
  ...
  },
  {
    ...
    displayName: '对话框',
    category: 'feedback',
    keywords: ['dialog', '对话框', '弹窗', '弹框', 'modal', 'popup', '窗口', '确认框'],
  ...
  },
  {
    ...
    displayName: '抽屉',
    category: 'feedback',
    keywords: ['drawer', '抽屉', '侧滑', 'sidebar', 'panel', '滑出'],
  ...
  },
  {
    ...
    displayName: '加载',
    category: 'feedback',
    keywords: ['loading', '加载', 'loading-bar', 'spinner', '转圈', '等待', 'v-loading'],
  ...
  },
  {
    ...
    displayName: '消息提示',
    category: 'feedback',
    keywords: ['message', '消息', '提示', 'toast', '通知', '轻提示', 'message-box'],
  ...
  },
  {
    ...
    displayName: '消息弹框',
    category: 'feedback',
    keywords: ['message-box', '消息弹框', '确认框', 'alert', 'confirm', 'prompt', '对话框'],
  ...
  },
  {
    ...
    displayName: '通知',
    category: 'feedback',
    keywords: ['notification', '通知', '通知框', 'notice', '提醒', '右下角通知'],
  ...
  },
  {
    ...
    displayName: '气泡确认框',
    category: 'feedback',
    keywords: ['popconfirm', '气泡确认', '确认气泡', '二次确认', 'popover', 'tooltip'],
  ...
  },
  {
    ...
    displayName: '气泡卡片',
    category: 'feedback',
    keywords: ['popover', '气泡卡片', '弹出层', '悬浮卡片', 'popup', 'dropdown'],
  ...
  },
  {
    ...
    displayName: '文字提示',
    category: 'feedback',
    keywords: ['tooltip', '文字提示', '提示', '悬浮提示', 'title', 'hint'],
  ...
  // ==================== 导航组件 ====================
  {
    ...
    displayName: '固钉',
    category: 'navigation',
    keywords: ['affix', '固钉', '固定', '吸顶', 'sticky', 'fixed'],
  ...
  },
  {
    ...
    displayName: '回到顶部',
    category: 'navigation',
    keywords: ['backtop', '回到顶部', '返回顶部', 'scroll-to-top', '置顶'],
  ...
  },
  {
    ...
    displayName: '面包屑',
    category: 'navigation',
    keywords: ['breadcrumb', '面包屑', '导航', '路径', 'path', '导航栏'],
  ...
  },
  {
    ...
    displayName: '下拉菜单',
    category: 'navigation',
    keywords: ['dropdown', '下拉菜单', '下拉', '菜单', 'menu', 'select'],
  ...
  },
  {
    ...
    displayName: '导航菜单',
    category: 'navigation',
    keywords: ['menu', '菜单', '导航', '导航菜单', 'sidebar', 'nav', '侧边栏'],
  ...
  },
  {
    ...
    displayName: '页头',
    category: 'navigation',
    keywords: ['page-header', '页头', '页面标题', 'header', 'title', '返回'],
  ...
  },
  {
    ...
    displayName: '步骤条',
    category: 'navigation',
    keywords: ['steps', '步骤条', '步骤', '流程', 'step', 'wizard', 'progress'],
  ...
  },
  {
    ...
    displayName: '标签页',
    category: 'navigation',
    keywords: ['tabs', '标签页', '标签', 'tab', '选项卡', '切换'],
  ...
  },
  {
    ...
    displayName: '锚点',
    category: 'navigation',
    keywords: ['anchor', '锚点', '目录', '快速导航', 'scroll-spy'],
  ...
  // ==================== 业务组件 ====================
  {
    ...
    displayName: '广告弹窗',
    category: 'business',
    keywords: ['ad-dialog', '广告弹窗', '广告', '弹窗', 'dialog', 'modal'],
    related: ['dialog'],
    complexity: 'medium',
  ...
  },
  {
    ...
    displayName: '员工搜索',
    category: 'business',
    keywords: ['emp-search', '员工搜索', '人员搜索', '员工选择', 'user-search'],
  ...
  },
  {
    ...
    displayName: '大文件上传',
    category: 'business',
    keywords: ['lbg-upload', '大文件上传', '分片上传', '断点续传', 'big-file'],
    related: ['upload'],
    complexity: 'complex',
  ...
  },
  {
    ...
    category: 'business',
    keywords: ['lyj-datepicker', '日期选择', '业务日期', 'datepicker'],
    related: ['date-picker'],
    complexity: 'medium',
  ...
  },
  {
    ...
    displayName: '公共SDK',
    category: 'business',
    keywords: ['lyj-public-sdk', 'SDK', '公共组件', '工具'],
    related: [],
    complexity: 'medium',
  ...
  },
  {
    ...
    displayName: '刷新组件',
    category: 'business',
    keywords: ['lyj-refresh', '刷新', '下拉刷新', 'pull-refresh'],
    related: [],
    complexity: 'simple',
  ...
  },
  {
    ...
    displayName: 'Excel处理',
    category: 'business',
    keywords: ['lyj-xlsx', 'excel', 'xlsx', '导入', '导出', '表格导出'],
  ...
  },
  {
    ...
    displayName: '迷你导航',
    category: 'business',
    keywords: ['mini-nav', '迷你导航', '快捷导航', '悬浮导航'],
    related: ['menu', 'anchor'],
    complexity: 'simple',
  ...
  },
  {
    ...
    displayName: '参数编辑器',
    category: 'business',
    keywords: ['params-editor', '参数编辑', 'JSON编辑', 'key-value'],
    related: ['form', 'input'],
    complexity: 'medium',
  ...
  },
  {
    ...
    displayName: 'PDF图片转换',
    category: 'business',
    keywords: ['pdf-img-convert', 'PDF', '图片', '转换', '预览'],
  ...
  },
  {
    ...
    displayName: 'PDF图片预览',
    category: 'business',
    keywords: ['pdf-img-preview', 'PDF预览', '图片预览', '预览'],
  ...
  },
  {
    ...
    displayName: '富文本编辑器',
    category: 'business',
    keywords: ['rich-text', '富文本', '编辑器', 'editor', 'wysiwyg', 'markdown'],
    related: ['input', 'form'],
    complexity: 'complex',
  ...
  },
  {
    ...
    displayName: '用户分组选择',
    category: 'business',
    keywords: ['select-user-grouping', '用户分组', '人员选择', '组织架构'],
  ...
  },
  {
    ...
    displayName: '设置海报',
    category: 'business',
    keywords: ['set-poster', '海报', '设置', '图片编辑'],
  ...
  },
  {
    ...
    displayName: 'PC图片查看器',
    category: 'business',
    keywords: ['viewer-pc', '图片查看器', '预览', 'gallery', 'lightbox'],
    related: ['image'],
    complexity: 'medium',
  ...
  },
  {
    ...
    category: 'business',
    keywords: ['wx-canvas-img', '微信', 'canvas', '图片生成', '分享图'],
    related: ['image'],
    complexity: 'complex',
  ...
  },
  {
    ...
    displayName: '计算器',
    category: 'business',
    keywords: ['calculator', '计算器', '计算', 'calc'],
  ...
  },
  {
    ...
    displayName: '评价组件',
    category: 'business',
    keywords: ['evaluate', '评价', '评分', '评论', 'rate'],
    related: ['rate'],
    complexity: 'medium',
  ...
  },
  {
    ...
    displayName: '图片懒加载插件',
    category: 'business',
    keywords: ['lazy-img-plugin', '懒加载', '图片懒加载', 'lazy-load', '性能优化'],
  ...
  },
  {
    ...
    displayName: '滚动条',
    category: 'business',
    keywords: ['scrollbar', '滚动条', '自定义滚动条', '滚动'],
    related: [],
    complexity: 'simple',
  ...
  },
  {
    ...
    displayName: '与或组件',
    category: 'business',
    keywords: ['andor', '与或', '逻辑', '条件', 'query-builder'],
    related: ['form', 'select'],
    complexity: 'complex',
  ...
  // ==================== 指南文档 ====================
  {
    ...
    displayName: '安装',
    category: 'guide',
    keywords: ['installation', '安装', 'install', 'npm', 'yarn', '快速开始', 'getting-started'],
    related: ['quickstart'],
    complexity: 'simple',
  ...
  },
  {
    ...
    displayName: '快速开始',
    category: 'guide',
    keywords: ['quickstart', '快速开始', '入门', 'hello-world', '开始使用'],
  ...
  },
  {
    ...
    displayName: '自定义主题',
    category: 'guide',
    keywords: ['custom-theme', '主题', '自定义', '样式', 'scss', 'css变量', 'theme'],
  ...
  },
  {
    ...
    displayName: '设计原则',
    category: 'guide',
    keywords: ['design', '设计', '原则', '规范', 'design-system'],
    related: [],
    complexity: 'simple',
  ...
  },
  {
    ...
    displayName: '注意事项',
    category: 'guide',
    keywords: ['beCareful', '注意事项', '注意', '警告', 'caveats', '陷阱'],
    related: [],
    complexity: 'simple',
  ...
  },
  {
    ...
    displayName: '部署',
    category: 'guide',
    keywords: ['deploy', '部署', '发布', 'production', 'build'],
    related: [],
    complexity: 'medium',
  ...
  },
  {
    ...
    displayName: '框架说明',
    category: 'guide',
    keywords: ['framework', '框架', 'vue', 'react', 'angular'],
    related: [],
    complexity: 'simple',
  ...
  },
  {
    ...
    displayName: 'JS错误处理',
    category: 'guide',
    keywords: ['jsError', '错误', 'error', '异常', 'bug', '调试'],
    related: [],
    complexity: 'medium',
  ...
  },
  {
    ...
    displayName: 'Nuxt集成',
    category: 'guide',
    keywords: ['nuxt', 'nuxt.js', 'ssr', '服务端渲染', 'nuxt3'],
  ...
  },
  {
    ...
    displayName: '过渡动画',
    category: 'guide',
    keywords: ['transition', '过渡', '动画', 'animation', 'fade', 'collapse'],
    related: [],
    complexity: 'medium',
