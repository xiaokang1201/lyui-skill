...
```html
<ly-switch v-model="value" active-color="#13ce66" inactive-color="#ff4949">
</ly-switch>
...
```html
<ly-switch v-model="value1" active-text="按月付费" inactive-text="按年付费">
</ly-switch>
<ly-switch
  style="display: block"
  v-model="value2"
...
```html
<ly-tooltip :content="'Switch value: ' + value" placement="top">
  <ly-switch
    v-model="value"
    active-color="#13ce66"
    inactive-color="#ff4949"
...
```html
<ly-switch v-model="value1" disabled> </ly-switch>
<ly-switch v-model="value2" disabled> </ly-switch>
<script>
  export default {
    data() {
      return {
...
```html
<ly-switch v-model="value1" loading> </ly-switch>
<ly-switch v-model="value2" loading> </ly-switch>
<script>
  export default {
    data() {
      return {
...
```html
<ly-switch v-model="value1" :loading="loading1" :before-change="beforeChange1">
</ly-switch>
<ly-switch v-model="value2" :loading="loading2" :before-change="beforeChange2">
</ly-switch>
<script>
