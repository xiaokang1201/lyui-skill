...
<template>
  <div class="block">
    ...
    <ly-date-picker v-model="value1" type="date" placeholder="选择日期">
    </ly-date-picker>
  </div>
  <div class="block">
...
<div class="container">
  ...
  <div class="block">
    ...
    <ly-date-picker v-model="value2" type="month" placeholder="选择月">
    </ly-date-picker>
  </div>
</div>
<div class="container">
  <div class="block">
    ...
    <ly-date-picker v-model="value3" type="year" placeholder="选择年">
    </ly-date-picker>
  </div>
  <div class="block">
