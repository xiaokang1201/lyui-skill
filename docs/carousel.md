...
<template>
  <div class="block">
    ...
    <ly-carousel height="150px">
      <ly-carousel-item v-for="item in 4" :key="item">
  ...
  <div class="block">
    ...
    <ly-carousel trigger="click" height="150px">
      <ly-carousel-item v-for="item in 4" :key="item">
        <h3 class="small">{{ item }}</h3>
      </ly-carousel-item>
    </ly-carousel>
...
```html
<template>
  <ly-carousel indicator-position="outside">
    <ly-carousel-item v-for="item in 4" :key="item">
      <h3>{{ item }}</h3>
    </ly-carousel-item>
  </ly-carousel>
...
```html
<template>
  <ly-carousel :interval="5000" arrow="always">
    <ly-carousel-item v-for="item in 4" :key="item">
      <h3>{{ item }}</h3>
    </ly-carousel-item>
  </ly-carousel>
...
```html
<template>
  <ly-carousel :interval="4000" type="card" height="200px">
    <ly-carousel-item v-for="item in 6" :key="item">
...
```html
<template>
  <ly-carousel height="200px" direction="vertical" :autoplay="false">
    <ly-carousel-item v-for="item in 3" :key="item">
      <h3 class="medium">{{ item }}</h3>
    </ly-carousel-item>
  </ly-carousel>
</template>
