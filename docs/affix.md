...
```html
<ly-affix :offset="120">
  <ly-button type="primary">距离顶部 120px</ly-button>
</ly-affix>
```
...
<div class="affix-container">
  <ly-affix target=".affix-container" :offset="80">
    <ly-button type="primary">指定容器</ly-button>
  </ly-affix>
</div>
```
...
```html
<ly-affix position="bottom" :offset="20">
  <ly-button type="primary">距离底部 20px</ly-button>
</ly-affix>
```
