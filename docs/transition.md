...
<template>
  <div>
    <ly-button @click="show = !show">Click Me</ly-button>
...
<template>
  <div>
    <ly-button @click="show2 = !show2">Click Me</ly-button>
...
<template>
  <div>
    <ly-button @click="show3 = !show3">Click Me</ly-button>

    <div style="margin-top: 20px; height: 200px;">
      <ly-collapse-transition>
        <div v-show="show3">
...
// collapse 展开折叠
import { ElCollapseTransition } from 'ly-ui'
import Vue from 'vue'
