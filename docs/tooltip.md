...
```html
<ly-tooltip content="Top center" placement="top">
  <ly-button>Dark</ly-button>
</ly-tooltip>
<ly-tooltip content="Bottom center" placement="bottom" effect="light">
  <ly-button>Light</ly-button>
</ly-tooltip>
```
...
```html
<ly-tooltip placement="top">
  <template #content> 多行信息<br />第二行信息 </template>
  <ly-button>Top center</ly-button>
</ly-tooltip>
```
...
<template>
  <ly-tooltip
    ...
    effect="light"
  >
    <ly-button @click="disabled = !disabled"
      >点击{{disabled ? '开启' : '关闭'}} tooltip 功能</ly-button
    >
  </ly-tooltip>
</template>
<script>
