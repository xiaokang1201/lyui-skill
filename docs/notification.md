...
```html
<template>
  <ly-button plain @click="open1"> 可自动关闭 </ly-button>
  <ly-button plain @click="open2"> 不会自动关闭 </ly-button>
</template>
...
<setup>
  ...
  import { ElNotification } from 'ly-ui';
...
```html
<template>
  <ly-button plain @click="open1"> 成功 </ly-button>
  <ly-button plain @click="open2"> 警告 </ly-button>
  <ly-button plain @click="open3"> 消息 </ly-button>
  <ly-button plain @click="open4"> 错误 </ly-button>
</template>
...
```html
<template>
  <ly-button plain @click="open1"> 右上角 </ly-button>
  <ly-button plain @click="open2"> 右下角 </ly-button>
  <ly-button plain @click="open3"> 左下角 </ly-button>
  <ly-button plain @click="open4"> 左上角 </ly-button>
</template>
...
```html
<template>
  <ly-button plain @click="open"> 偏移的消息 </ly-button>
</template>
...
```html
<template>
  <ly-button plain @click="open"> 使用 HTML 片段 </ly-button>
</template>
...
```html
<template>
  <ly-button plain @click="open"> 隐藏关闭按钮 </ly-button>
</template>
