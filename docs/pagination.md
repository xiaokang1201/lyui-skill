...
<template>
  <div>
    <p>页数较少时的效果</p>
    <ly-pagination :total="50"> </ly-pagination>
  </div>

  <div>
    <p>大于 7 页时的效果</p>
    <ly-pagination :total="1000"> </ly-pagination>
  </div>
</template>
```
...
```html
<template>
  <ly-pagination background layout="prev, pager, next" :total="1000">
  </ly-pagination>
</template>
```
...
```html
<template>
  <ly-pagination small layout="prev, pager, next" :total="50"> </ly-pagination>
</template>
```
...
<template>
  <div>
    <ly-switch v-model="value"> </ly-switch>
    <ly-pagination
...
| page-size            | 每页显示条目个数，支持 v-model 双向绑定     | [25, 50, 75, 100, 200]                 |                                | number   | —                                                                 | 10                                     |
