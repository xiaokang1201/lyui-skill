...
```html
<ly-calendar v-model="value"> </ly-calendar>
...
```html
<ly-calendar :range="[new Date(2019, 2, 4), new Date(2019, 2, 24)]">
</ly-calendar>
```
...
```html
<ly-calendar ref="calendar">
  <template #header="{date}">
    <span>自定义头部内容</span>
    <span>{{ date }}</span>
    <ly-button-group>
      <ly-button size="mini" @click="selectDate('prev-year')">上一年</ly-button>
      <ly-button size="mini" @click="selectDate('prev-month')"
        >上个月</ly-button
      >
      <ly-button size="mini" @click="selectDate('today')">今天</ly-button>
      <ly-button size="mini" @click="selectDate('next-month')"
        >下个月</ly-button
      >
      <ly-button size="mini" @click="selectDate('next-year')">下一年</ly-button>
    </ly-button-group>
  </template>
</ly-calendar>
