...
<template>
  <ly-space wrap>
    <ly-card class="box-card" style="width: 250px" v-for="i in 3" :key="i">
      <template #header>
        <div class="card-header">
          <span>Card name</span>
          <ly-button class="button" type="text">Operation button</ly-button>
        </div>
      </template>
...
```html
<template>
  <ly-space direction="vertical">
    <ly-card class="box-card" style="width: 250px" v-for="i in 2" :key="i">
      <template #header>
        <div class="card-header">
          <span>Card name</span>
          <ly-button class="button" type="text">Operation button</ly-button>
...
```html
<template>
  <ly-space direction="vertical" alignment="start" :size="30">
    <ly-radio-group v-model="size">
      <ly-radio :label="'mini'">迷你</ly-radio>
      <ly-radio :label="'small'">小</ly-radio>
      <ly-radio :label="'medium'">中等</ly-radio>
      <ly-radio :label="'large'">大号</ly-radio>
    </ly-radio-group>

    <ly-space wrap :size="size">
      <ly-card class="box-card" style="width: 250px" v-for="i in 3" :key="i">
        <template #header>
          <div class="card-header">
            <span>Card name</span>
...
```html
<template>
  <ly-space :size="size" spacer="|">
    <div v-for="i in 2" :key="i">
      <ly-button> button {{ i }} </ly-button>
    </div>
  </ly-space>
</template>
...
```typescript
import { ElDivider } from 'ly-ui'
```

```html
<template>
  <ly-space :size="size" :spacer="spacer">
    <div v-for="i in 2" :key="i">
      <ly-button> button {{ i }} </ly-button>
    </div>
  </ly-space>
...
<template>
  <div>
    <div style="margin-bottom:15px">
      fill: <ly-switch v-model="fill"></ly-switch>
    </div>
    <ly-space :fill="fill" wrap>
      <ly-card class="box-card" v-for="i in 3" :key="i">
        <template #header>
          <div class="card-header">
            <span>Card name</span>
            <ly-button class="button" type="text">Operation button</ly-button>
...
<template>
  <div>
    <div style="margin-bottom: 15px">
      direction:
      <ly-radio v-model="direction" label="horizontal">horizontal</ly-radio>
      <ly-radio v-model="direction" label="vertical">vertical</ly-radio>
    </div>
    <div style="margin-bottom: 15px">
      fillRatio:<ly-slider v-model="fillRatio"></ly-slider>
    </div>
    <ly-space
      fill
      wrap
      ...
      style=" width: 100%"
    >
      <ly-card class="box-card" v-for="i in 5" :key="i">
        <template #header>
          <div class="card-header">
            <span>Card name</span>
            <ly-button class="button" type="text">Operation button</ly-button>
